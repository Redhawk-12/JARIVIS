...
HELP_STRING = f"★ Häwk ʙᴏᴛs ʜᴇʟᴘ ᴍᴇɴᴜ ★\n\n» **ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴꜱ ꜰᴏʀ ʜᴇʟᴘ**\n» **ᴅᴇᴠᴇʟᴏᴘᴇʀ: @RED_HAWK_001**"
...
HELP_BUTTON = [
    ...
    [
      Button.url("• ᴄʜᴀɴɴᴇʟ •", "https://t.me/Bhaicharagroupchat"),
      Button.url("• sᴜᴘᴘᴏʀᴛ •", "https://t.me/Noble_Redhawk")
    ]
  ]
    ...
    if event.sender_id in SUDO_USERS:
        try:
          await event.client.send_file(event.chat_id,
              "https://graph.org/file/f3d91455a046ad72cc6e2.jpg",
              caption=HELP_STRING,
              buttons=HELP_BUTTON
              )
    ...
    if event.query.user_id in SUDO_USERS:    
        await event.edit(
            ...
            buttons=[
              ...
              [
                Button.url("• ᴄʜᴀɴɴᴇʟ •", "https://t.me/Noble_Redhawk"),
                Button.url("• sᴜᴘᴘᴏʀᴛ •", "https://t.me/bhaicharagroupchat")
              ]
            ]
          )
    else:
        await event.answer("ᴘᴀʜʟᴇ ʜᴀᴡᴋ ᴘᴀᴘᴀ sᴇ sᴜᴅᴏ ʟᴇʟᴏ 𖤍!! @Noble_Redhawk", cache_time=0, alert=True)
...
async def help_spam(event):
    if event.query.user_id in SUDO_USERS:    
        ...
        await event.answer("ᴘᴀʜʟᴇ ʜᴀᴡᴋ ᴘᴀᴘᴀ sᴇ sᴜᴅᴏ ʟᴇʟᴏ 𖤍 !! @RED_HAWK_001", cache_time=0, alert=True)
